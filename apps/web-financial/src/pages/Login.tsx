    ...
    <div className="auth-layout">
      <div className="auth-left">
        ...
        <p className="auth-tagline">
          Finance &amp; analytics console for revenue, refunds and settlements at a glance.
        </p>
        <div className="auth-features">
          <div className="auth-feature">
            <BarChartOutlined /> Revenue trends &amp; growth analytics
          </div>
          <div className="auth-feature">
            <CheckCircleOutlined /> Refund &amp; settlement workflow control
          </div>
          <div className="auth-feature">
            <SafetyCertificateOutlined /> Secure financial role access
          </div>
        </div>
      </div>
      <div className="auth-right">
        <div className="auth-form-wrap">
          <div className="auth-form-title">Finance sign in</div>
          ...
          <Form layout="vertical" onFinish={onFinish}>
            ...
            >
              <Input placeholder="finance@foodiebus.com" size="large" />
            </Form.Item>
            <Form.Item
              name="password"
              label="Password"
